            ...
            <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
              ...
              <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                ...
                <span className="mt-4  text-[#001]">
                  HTML/CSS | NODE JS EXPRESS | REACT JS | MONGOOSE | JAVASCRIPT | PHP | ARDUINO PL | SEQUELIZE | PUBLIC SPEAKING | more....
                </span>
              </div>
            </div>
            <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
	...
	<path class="st0" d="M171.501,208.271c5.21,29.516,13.966,55.554,25.494,68.38c0,15.382,0,26.604,0,35.587
		...
		C152.405,196.99,159.338,203.934,171.501,208.271z"/>
              ...
              <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                ...
                <span className="mt-4mt-4  text-[#001]">
                  INNOVATIVE/CREATIVE | COLLABORATIVE | TIME MANAGEMENT | HONEST | QUICK LEARNER | DESICION TAKER| more...
                </span>
              </div>
            </div>
          </div>
